...
- **Fonts:** Culmus STAM Sefarad/Ashkenaz (GPL with font exception) and Schwarz STAM Ari. Vowel marks and punctuation are merged in from Frank Ruehl CLM by `tools/build-fonts.py`.
