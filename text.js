...
export const TEXT = [
  ...
  },
  {
    ...
    lines: [
      ...
      'כָּאָמוּר: "וְאָכַלְתָּ וְשָׂבָֽעְתָּ וּבֵרַכְתָּ אֶת יְהֹוָה אֱלֹהֶֽיךָ עַל הָאָֽרֶץ הַטֹּבָה אֲשֶׁר נָֽתַן לָךְ".',
  ...
  {
    type: 'p',
    lines: [['וְתִבְנֶה יְרוּשָׁלַֽיִם עִירָךְ בִּמְהֵרָה בְיָמֵֽינוּ. בָּרוּךְ אַתָּה יְהֹוָה, בּוֹנֵה יְרוּשָׁלָֽיִם', { lbl: 'בלחש:', t: 'אָמֵן', paren: true }, '.']],
  },
  {
  ...
  },
  {
    ...
    lines: [
      ...
      'עוֹשֶׂה שָׁלוֹם בִּמְרוֹמָיו הוּא בְרַחֲמָיו יַעֲשֶׂה שָׁלוֹם עָלֵֽינוּ וְעַל כׇּל עַמּוֹ יִשְׂרָאֵל וְאִמְרוּ אָמֵן.',
    ],
  },
];
